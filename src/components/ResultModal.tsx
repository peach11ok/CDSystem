          ...
          <body>
            ...
            <div class="section">
              ...
              <div>
                <h3>变化检测结果</h3>
                <div class="image-container">
                  <img src="${result.changeDetectionImage}" alt="变化检测结果" />
                </div>
              </div>
              <div>
                <h3>语义分割结果</h3>
                <div class="grid">
                  <div class="image-container">
                    <h4>图片1语义分割</h4>
                    <img src="${result.segmentationImages.image1}" alt="语义分割结果1" />
                  </div>
                  <div class="image-container">
                    <h4>图片2语义分割</h4>
                    <img src="${result.segmentationImages.image2}" alt="语义分割结果2" />
                  </div>
                </div>
              </div>
              <div>
